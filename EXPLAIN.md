...
## More About This
If a network admin were to block XHR requests to a website(*which they and [filters]() do lol*), the website assets will not load **but** since we used **[libcurl.js](https://github.com/ading2210/libcurl.js)** *it bypasses the network blocks.*
